        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              {/* X */}
              <li>
                <Link href="https://twitter.com/SolanaDaMa" className="flex justify-center items-center text-blue-600 dark:bg-gray-900 hover:text-gray-100 hover:bg-blue-600 rounded-full transition duration-150 ease-in-out" aria-label="Twitter">
              ...
              {/* Github */}
              <li className="ml-4">
                <Link href="https://github.com/solanadama/solanadama/tree/main" className="flex justify-center items-center text-blue-600 dark:bg-gray-900 hover:text-gray-100 hover:bg-blue-600 rounded-full transition duration-150 ease-in-out" aria-label="Github">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              {/* Telegram */}
              <li className="ml-4">
                <Link href="https://t.co/30uMljzVyZ" className="flex justify-center items-center text-blue-600 dark:bg-gray-900 hover:text-gray-100 hover:bg-blue-600 rounded-full transition duration-150 ease-in-out" aria-label="Linkedin">
