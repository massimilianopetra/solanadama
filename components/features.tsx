        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Token Trustability</h4>
              <p className="text-lg text-gray-400 text-center">
                A tool that enables new token startups to declare verifiable milestones over time against an economic commitment guaranteed by the DaMa token.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Certified reviews </h4>
              <p className="text-lg text-gray-400 text-center">
                Certified reviews based on trades carried out by users on the Solana blockchain.
                Rewardable over time with DaMa Token
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="300" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">AI Trading BOT</h4>
              <p className="text-lg text-gray-400 text-center">
                Automatic BOT trading to invest in tokens presented on the SolanaDama platform.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Token Launch Program</h4>
              <p className="text-lg text-gray-400 text-center">
                Token launch program for fundraising and advertising.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Targeted Airdrops</h4>
              <p className="text-lg text-gray-400 text-center">
                Targeted airdrop program to allow startups to direct their economic efforts towards interested potential investors.
                Announcement tool for users who would like to participate as early investors in the birth of new tokens.
              </p>
            </div>
