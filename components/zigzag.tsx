      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
			...
			Unlocking Infinite Solutions: Your go-to platform for reliable cryptocurrency insights. We offer expert evaluations empowering investors with transparent, informed decisions. 
			Promoting trust and credibility worldwide.
			</p>
          </div>
