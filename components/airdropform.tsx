...
export default function AirdropForm() {
    ...
    async function checkAirdrop(e: FormEvent<HTMLFormElement>) {
        e.preventDefault();
        const formData = new FormData(e.currentTarget);
        const address = String(formData.get("address"));
        console.log('ADRESS: ', address);
    ...
    return (
        <section>
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                ...
                {/* form check airdrop*/}
                {showFormCheck && (
                    <div className=" bg-gray-200 dark:bg-gray-800 rounded-xl p-6 border border-blue-700 py-10 px-8 md:py-16 md:px-12"
                        data-aos="fade-up">
                            ...
                            <svg width="238" height="110" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <defs>
                                    <linearGradient id="illustration-04" x1="369.483" y1="-84.633" x2="139.954" y2="-199.798" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="#44f" stopOpacity=".01" />
                                        <stop offset="1" stopColor="#44f" stopOpacity=".24" />
                                    </linearGradient>
                                </defs>
                        ...
                        <div>
                            <div className="mb-6 lg:mr-16 lg:mb-0 text-center lg:text-left lg:w-1/2">
                                <h3 className="h3 dark:text-white mb-2">Airdrop check</h3>
                            </div>

                            <form className="w-full" onSubmit={checkAirdrop}>
                                <div className="justify-center max-w-xs mx-auto sm:max-w-md lg:max-w-none p-2">
                                    <div className='p-4'>
                                        <input type="text"
                                            name="address"
                                    ...
                                    <button
                                        className="text-white bg-green-700 hover:bg-green-900 rounded-xl p-3 w-1/2"
                                        type="submit"
                                        disabled={false}
                                    >
                                        Check
                ...
                {showFormSubsription && (
                    <div className=" bg-gray-200 dark:bg-gray-800 rounded-xl p-6 border border-blue-700 py-10 px-8 md:py-16 md:px-12"
                        ...
                        <div>
                            <div className="mb-6 lg:mr-16 lg:mb-0 text-center lg:text-left lg:w-1/2">
                                <h3 className="h3 dark:text-white mb-2">Subscription form</h3>
                            </div>

                            <form className="w-full" onSubmit={subscribeAirdrop}>
                                <div className="justify-center max-w-xs mx-auto sm:max-w-md lg:max-w-none p-2">
                                    <div className='p-4'>
                                        <input type="text"
                                            name="address"
                                    ...
                                    <div className='p-4'>
                                        <input type="text"
                                            name="url"
                                            className="w-full appearance-none bg-blue-700 border border-blue-500 focus:border-blue-300 rounded-sm px-4 py-3 mb-2 sm:mb-0 sm:mr-2 text-white placeholder-blue-400" placeholder="Link to X repost" aria-label="Link to X repost" />
                                    </div>
                                    <button
                                        className="text-white bg-green-700 hover:bg-green-900 rounded-xl p-3 w-1/2"
                                        type="submit"
                ...
                {showThankyou && (
                    <p>
                        Thank you for your airdrop subscription
                    </p>
                )}
